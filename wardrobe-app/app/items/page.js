...
export default function ItemsPage() {
	...
	return (
		<>
			...
			<main className='flex-1 flex flex-col bg-white-pink px-10 py-6 gap-y-4'>
				<div className='flex flex-row items-center'>
					<div className='flex flex-row items-center gap-6'>
						<h1 className='text-4xl text-black-brown font-bold'>Items</h1>
						<button className='bg-black-brown text-white-pink font-medium text-base p-[7px] rounded-md hover:opacity-70 transition-all'>
